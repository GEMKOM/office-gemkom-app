...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    new HeaderComponent({
        ...
        subtitle: 'Sevkiyat maliyeti girilmemiş ve girilmiş iş emirleri',
...
function initHasEntriesTable() {
    hasEntriesTable = new TableComponent('has-entries-table-container', {
        title: 'Sevkiyat Maliyeti Girilmiş İş Emirleri',
...
async function saveLines() {
    ...
    try {
        await submitShippingCostLines(currentJobOrderForLines, lines);
...
async function loadHasEntries(options = {}) {
    ...
    try {
        const response = await getJobOrdersHasShipping(params);
        const results = extractResultsFromResponse(response);
