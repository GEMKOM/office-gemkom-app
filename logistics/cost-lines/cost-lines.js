...
import {
    getShippingPendingJobOrders,
    getShippingCostLines,
    createShippingCostLine,
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    new HeaderComponent({
        title: 'Sevkiyat Maliyet Satırları',
        subtitle: 'Sevkiyat maliyeti girilmemiş iş emirleri',
...
function initPendingTable() {
    pendingTable = new TableComponent('pending-table-container', {
        title: 'Sevkiyat Maliyeti Girilmemiş İş Emirleri',
        icon: 'fas fa-truck',
        columns: [
        ...
        emptyMessage: 'Sevkiyat maliyeti bekleyen iş emri yok.',
...
function initLinesModal() {
    ...
    if (!container) return;
    container.innerHTML = `
        <div class="modal fade" id="shipping-lines-modal" tabindex="-1">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"><i class="fas fa-truck me-2"></i><span id="lines-modal-title">Sevkiyat Maliyet Satırları</span></h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div id="add-line-form-container" style="display:none;" class="mb-3 p-3 border rounded bg-light">
                            ...
                            <div class="row g-2">
                                <div class="col-12"><label class="form-label">Açıklama <span class="text-danger">*</span></label><input type="text" class="form-control form-control-sm" id="line-description" placeholder="Örn: Kargo"></div>
    ...
    `;
    linesModal = document.getElementById('shipping-lines-modal');
...
async function loadLines() {
    ...
    try {
        const lines = await getShippingCostLines(currentJobOrderForLines);
...
async function loadPending(options = {}) {
    ...
    try {
        const response = await getShippingPendingJobOrders(params);
